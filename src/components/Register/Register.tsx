...
const Register = () => {
  ...
  {/* Blood Group */}
        ...
        />
            ...
            <p className="text-gray-400 text-sm pt-4 text-center">Already have an account?<span className="text-primary"><Link href={'/login'}>Login</Link></span></p>
            </div>
          </form>
        </div>
        ...
        <div className="lg:w-1/2 lg:text-start text-center w-full">
          ...
          <h2 className="text-3xl font-bold font-poppins"> Join Us, Save Lives. Connecting Communities through Blood Donation.</h2>
          ...
          <div className="mt-2">
            ...
            <div className="flex py-1 sm:flex-row flex-col my-4 justify-between text-gray-400 text-sm items-start">
               ...
               <div className="flex mb-2 flex-col items-start">
                <h2 className="text-xl font-bold text-gray-700  mb-5">Kakrail, Dhaka</h2>

...
import MoImage from "../../../public/assets/icon/userIcon.png";

type DonateCartProps = { person: IUser };

const DonateCart: React.FC<DonateCartProps> = ({ person }) => {
  return (
    <Link href={`donate-list/${person._id}`} >
          ...
          >
            <div className="flex flex-1 flex-col p-8">
              <Image
                ...
                src={(person?.imgUrl as any) ?? MoImage}
                width={128}
                height={128}
                alt=""
              />

        ...
        <div className="flex h-auto min-w-[100vw] flex-col items-center justify-end bg-[#f2f2f7] py-6 md:h-64">
          <div className="flex flex-col items-center gap-y-4 py-5">
            ...
            <p className="text-sm text-[#808080] sm:text-base">
              Last Updated as of January 02, 2024
            </p>
          </div>
        </div>
        {/* <!-- Content Container --> */}
        <div className="mx-auto w-full max-w-5xl py-12 md:py-16 lg:py-20">
          ...
          <div className="flex flex-col items-center  gap-y-14">
            <p className="max-w-3xl text-center text-sm sm:text-base">
              ...
              blood donors in their area and make the process of donating blood
              more convenient for both parties. The platform also provides
              information about blood donation and the importance of donating
              blood.
            </p>
